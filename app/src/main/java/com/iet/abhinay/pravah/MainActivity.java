...
//    }
    ...
    private void displaySelectedScreen(int id) {
        ...
        if(id==R.id.home){
            ...
            Intent intent=new Intent(Intent.ACTION_VIEW);
            intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.iet.abhinay.pravah"));
            startActivity(intent);
        } else if (id == R.id.share) {
            Intent shareIntent=new Intent(android.content.Intent.ACTION_SEND);
            shareIntent.setType("text/italic");
            String app_url = "https://play.google.com/store/apps/details?id=com.iet.abhinay.pravah";
            shareIntent.putExtra(Intent.EXTRA_TEXT, app_url);
            startActivity(Intent.createChooser(shareIntent, "Share via"));
        }
